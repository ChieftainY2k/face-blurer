...
```
# 1080p 30fps
docker run --gpus all -v $(pwd):/data linuxserver/ffmpeg -r 30 -f image2 -s 1920x1080 -i "/data/output/frame_%10d.png.blurred.png" -vcodec libx264 -crf 20 "/data/output/video-blurred-1080p-30fps.mp4"

# 1080p 30fps, DEBUG MODE
docker run --gpus all -v $(pwd):/data linuxserver/ffmpeg -r 30 -f image2 -s 1920x1080 -i "/data/output/frame_%10d.png.debug.png" -vcodec libx264 -crf 20 "/data/output/video-debug-1080p-30fps.mp4"

# 4k 30fps
docker run --gpus all -v $(pwd):/data linuxserver/ffmpeg -r 30 -f image2 -s 3840x2160 -i "/data/output/frame_%10d.png.blurred.png" -vcodec libx264 -crf 20 "/data/output/video-blurred-4k-30fps.mp4"
...
# 4K 60fps
ffmpeg -r 59.94005994005994005994 -hwaccel "cuda" -c:v h264_nvenc -preset slow -cq 20 -f image2 -s 3840x2160 -i "output/frame_%10d.png.blurred.png" "output/video-blurred-4k-60fps.mp4" 
